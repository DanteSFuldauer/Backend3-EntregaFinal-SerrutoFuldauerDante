...
mongoose.connect("mongodb://127.0.0.1:27017/70360-test");
...
describe("===== TEST PETDAO =====", () => {
  ...
  //Describir tarea del test
  it("Debe retornar un array de pets", async () => {
    const pets = await petDao.getAll(); //llamado a todas las mascotas
  ...
  it("Debe eliminar una mascota", async () => {
     ...
     expect(pet).to.be.null; //comprobar que fue borrado
  })
